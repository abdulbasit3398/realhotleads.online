          ...
          <div class="d-flex">
            ...
            <div class="navbar-brand-box">
              <a href="{{route('dashboard')}}" class="logo logo-dark">
                ...
                <span class="logo-lg">
                  <!-- <img src="{{asset('assets/images/logo-light.jpg')}}" alt="" width="150"> -->
                </span>
              </a>

              <a href="https://automatedcontactgenerator.com/" class="logo logo-light">
                <span class="logo-sm">
...
<div class="dropdown-menu dropdown-menu-end">
  ...
  <a class="dropdown-item" href="{{route('my-wallet')}}"><i class="bx bx-wallet font-size-16 align-middle me-1"></i> <span key="t-my-wallet">My Wallet</span></a>
...
<span style="color: green;font-size: initial;">$ {{number_format(\Auth::user()->user_wallet->withdrawable_funds + \Auth::user()->user_wallet->non_withdrawable_funds , 2)}}</span>
@else
