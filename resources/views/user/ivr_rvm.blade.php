...
<div class="container-fluid">
      ...
      <div class="row">
        <div class="col-12">
          <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">CREATE INTERACTIVE VOICE RESPONSE</h4>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title mb-4">Create New IVR Campaign</h4>
              <form>
                <div class="row mb-4">
                  <label for="projectname" class="col-form-label col-lg-2">Campaign Name</label>
                  <div class="col-lg-10">
                    <input id="projectname" name="projectname" type="text" class="form-control" placeholder="Enter Project Name...">
                  </div>
                </div>
                <div class="row mb-4">
                  <label for="projectdesc" class="col-form-label col-lg-2">Campaign Description</label>
                  <div class="col-lg-10">
                ...
                <div class="row mb-4">
                  <label class="col-form-label col-lg-2">Campaign Start/End</label>
                  <div class="col-lg-10">
  ...
  <div class="w-100">
    <div class="d-md-flex">
      <div class="card filemanager-sidebar me-md-2">
        <h4 class="card-title pt-3 px-3">IVR File Manager</h4>
        <div class="card-body">
...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-12">
      <div class="page-title-box d-sm-flex align-items-center justify-content-between">
        <h4 class="mb-sm-0 font-size-18">CREATE RINGLESS VOICEMAIL</h4>
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title mb-4">Create New RVM Campaign</h4>
          <form>
            <div class="row mb-4">
              <label for="projectname" class="col-form-label col-lg-2">Campaign Name</label>
              <div class="col-lg-10">
...
<div class="d-xl-flex" id="Cloud" name="Cloud">
  <div class="w-100">
    <div class="d-md-flex">
      <div class="card filemanager-sidebar me-md-2">
        <h4 class="card-title pt-3 px-3">RVM File Manager</h4>
        <div class="card-body">
