	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h4 style="margin: 0;">Bulk Import Numbers</h4>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body upload-modal-body">
				 <form method="POST" action="{{route('bulk-import-list-clean')}}" enctype="multipart/form-data">
				 	@csrf
				 	<div class="input-group">
            <input type="file" class="form-control" name="contact_file" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" aria-label="Upload" required accept="csv,xlsx,xls">
            <button class="btn btn-primary" type="submit" id="inputGroupFileAddon04">Upload</button>
          </div>
          <br/>
          <div class="row">
          	<div class="col-md-12">
          		<a href="{{asset('assets/samples/sample_list_cleaner.xlsx')}}" download="sample_list_cleaner.xlsx" class="btn btn-warning">Download Sample</a>
          	</div>
          </div>
				 </form>
			</div>
...
<div class="container-fluid">
	...
	<div class="alert alert-success alert-dismissible fade show" role="alert" id="show-result" style="display:none;">
    ...
    <div class="col-12">
      <div class="page-title-box d-sm-flex align-items-center justify-content-between">
        <h4 class="mb-sm-0 font-size-18">List Cleaner</h4>
      </div>
    </div>
  </div>
				...
				<div class="card-body">
					...
					<form method="post" >
						...
						<div class="form-group">
							<label class="form-label">Phone Number Verify</label>
							<input type="text" name="phone_number" required class="form-control phone_number">
						</div>
						<br/>
						<div class="form-group">
							<button class="btn btn-primary check_number" type="button">Submit</button>
							<a href="#" class="btn btn-success waves-effect waves-light upload-modal-button" data-id="20 usd package" data-bs-toggle="modal" data-bs-target=".bs-example-modal-lg">Bulk Import</a>
						</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('.check_number').click(function(){
			...
			$.ajax({
				method: "POST",
				url: '{{route("check-list-cleaner")}}',
				data: {"_token": "{{ csrf_token() }}",phone_number:phone_number},
				success: function(response){
					$('#show-result').show();
          console.log(response['valid']);
					if(response['valid'])
						$('#message').html(response['clean_number']+' is a valid number');
					else
						$('#message').html(response['clean_number']+' is not a valid number');
				}
			});
